const FilterList = ({ expertiseFilter, setExpertiseFilter, setPagination }) => {

    const handleChange = (event, expertise, index) => {
              ...
              <h3 className="pb-4">Expertise</h3>
              {
                expertiseFilter.map( (expertise, index) => (
                  <div className="mt-1" key={index}>
                    <label>
                        <input
                          type="checkbox" className="form-checkbox h-4 w-4 mr-2 mb-2" 
                          onChange={e => handleChange(e, expertise, index)}
                          checked={expertise.selected} />
